<%-- 
    Document   : search
    Created on : Jun 11, 2021, 9:53:45 AM
    Author     : ASUS
--%>

<%--<%@page import="java.util.ArrayList"%>
<%@page import="java.util.List"%>
<%@page import="anpdt.registration.RegistrationDTO"%>--%>
...
<html>
    ...
    <body>
        ...
        <%--<%
            ...
            if(cookies!= null){
                %>
                <font color="red"> <%= cookies[cookies.length - 1].getName() %> </font>
                <%
            }
        ...
        <form action="DispatchController">
            ...
            <%
                ...
                if (searchValue != null) {
                    ArrayList<RegistrationDTO> resultList = (ArrayList<RegistrationDTO>) request.getAttribute("SEARCH_RESULT");
                    if (resultList != null) {
            %>
            <table border="1">
                <thead>
                ...
                <tbody>
                    <%
                    int count = 0;
                    for (RegistrationDTO dto : resultList) {
